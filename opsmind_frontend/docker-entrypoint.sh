...
envsubst '${OPSMIND_API_URL} ${OPSMIND_TICKET_URL} ${OPSMIND_WORKFLOW_API_URL} ${OPSMIND_AI_API_URL} ${OPSMIND_INVENTORY_AI_API_URL} ${OPSMIND_SLA_URL} ${OPSMIND_NOTIFICATION_URL} ${OPSMIND_INVENTORY_API_URL} ${OPSMIND_REPORT_API_URL}' \
