...
export async function publishTicketCreated(ticket: Ticket): Promise<void> {
  ...
  const payload = {
    ...
    data: {
      ...
      affected_device_id: (ticket as any).affected_device_id ?? null,
      affected_device_name: (ticket as any).affected_device_name ?? null,
      os_type: (ticket as any).os_type ?? null,
      issue_scope: (ticket as any).issue_scope ?? null,
      remote_support_consent: (ticket as any).remote_support_consent ?? false,
      remote_support_consent_at: (ticket as any).remote_support_consent_at ?? null,
      remote_support_consent_by: (ticket as any).remote_support_consent_by ?? null,
      ai_agent_eligible: (ticket as any).ai_agent_eligible ?? false,
      ai_agent_eligibility_reason: (ticket as any).ai_agent_eligibility_reason ?? null,
